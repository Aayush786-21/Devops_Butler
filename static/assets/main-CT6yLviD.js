import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */class et{constructor(){this.routes={"/":"projects","/deploy":"deploy","/history":"history","/repositories":"repositories","/domain":"domain","/env-vars":"env-vars","/settings":"settings","/logs":"logs"},this.currentPage=null,this.init()}init(){document.querySelectorAll(".nav-item").forEach(t=>{t.addEventListener("click",n=>{n.preventDefault();const o=t.getAttribute("href");this.navigate(o)})}),window.addEventListener("popstate",()=>{this.loadPage(window.location.pathname)}),this.loadPage(window.location.pathname)}navigate(t){window.history.pushState({},"",t),this.loadPage(t)}loadPage(t){const n=this.routes[t]||"dashboard";if(n==="deploy"){r=null;const o=document.getElementById("projectSidebar");o&&(o.style.display="none");const s=document.getElementById("sidebar");s&&(s.style.display="block")}this.showPage(n),this.updateActiveNav(t),this.updatePageTitle(n),window.scrollTo({top:0,behavior:"smooth"})}showPage(t){document.querySelectorAll(".page").forEach(o=>{o.style.display="none"});const n=document.getElementById(`page-${t}`);if(n){if(n.style.display="block",t==="deploy"){const o=document.getElementById("deploy-status"),s=document.getElementById("deploy-success");o&&(o.textContent="",o.style.color=""),s&&(s.style.display="none")}}else{const o=document.getElementById("page-dashboard");o&&(o.style.display="block")}this.currentPage=t,this.loadPageData(t)}updateActiveNav(t){document.querySelectorAll(".nav-item").forEach(n=>{n.classList.remove("active"),n.getAttribute("href")===t&&n.classList.add("active")})}updatePageTitle(t){const n={projects:"Projects",deploy:"Deploy",history:"History",repositories:"Repositories",domain:"Domain","env-vars":"Environmental Variables",settings:"Settings",logs:"Logs"};document.getElementById("pageTitle").textContent=n[t]||"Dashboard"}loadPageData(t){switch(t){case"dashboard":Se();break;case"projects":O(),Se();break;case"history":_e();break;case"repositories":Yt();break;case"domain":ut();break;case"env-vars":De();break;case"settings":Qe();break}}}const U=new et;window.router=U;async function tt(e){const t=await st();if(!t)return;const n=_.find(a=>a.id==e),o=n?n.name:"this project";if(await nt(o))try{console.log("Deleting project with token:",t.substring(0,20)+"...");const a=await fetch(`/projects/${e}`,{method:"DELETE",headers:{Authorization:`Bearer ${t}`}});if(console.log("Delete response status:",a.status),!a.ok){const i=await a.json().catch(()=>({}));if(console.error("Delete error response:",i),a.status===401){p("Session expired. Please login again.","error"),localStorage.removeItem("access_token"),localStorage.removeItem("authToken"),setTimeout(()=>{window.location.href="/login"},2e3);return}throw new Error(i.detail||"Failed to delete project")}_=_.filter(i=>i.id!=e),z=z.filter(i=>i.id!=e),X(z),p("Project deleted","success")}catch(a){console.error("Delete project error:",a),p(`Delete failed: ${a.message}`,"error")}}function nt(e){return new Promise(t=>{const n=document.createElement("div");n.className="modal-overlay";const o=document.createElement("div");o.className="delete-confirmation-modal",o.innerHTML=`
    ...
    `,n.appendChild(o),document.body.appendChild(n);const s=o.querySelector(".cancel-btn"),a=o.querySelector(".delete-btn"),i=()=>{document.body.removeChild(n)};s.onclick=()=>{i(),t(!1)},a.onclick=()=>{i(),t(!0)},n.onclick=l=>{l.target===n&&(i(),t(!1))},a.focus()})}function ot(e){try{const n=JSON.parse(atob(e.split(".")[1])).exp*1e3,o=Date.now();return n<o+5*60*1e3}catch{return!0}}async function st(){const e=localStorage.getItem("access_token")||localStorage.getItem("authToken");return!e||ot(e)?(p("Session expired. Please login again.","error"),localStorage.removeItem("access_token"),localStorage.removeItem("authToken"),setTimeout(()=>{window.location.href="/login"},2e3),null):e}let ne=localStorage.getItem("access_token")||localStorage.getItem("authToken"),fe=localStorage.getItem("username");document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("sidebarSearch");e&&(e.value="",e.setAttribute("autocomplete","off")),be(),window.location.pathname==="/login"||window.location.pathname.includes("login.html")||setTimeout(()=>{if(ne&&fe){at(),vn();const n=document.getElementById("sidebarSearch");n&&n.value===fe&&(n.value="");const o=document.getElementById("page-projects");o&&window.location.pathname==="/"&&(o.style.display="block")}},100)});function be(){const e=document.getElementById("userSection"),t=document.getElementById("authButtons"),n=document.getElementById("logoutBtn"),o=document.getElementById("newDeployBtn");document.getElementById("userName"),document.getElementById("userEmail"),document.getElementById("userAvatar");const s=window.location.pathname==="/login"||window.location.pathname.includes("login.html");ne&&fe?(e.style.display="flex",t.style.display="none",n.style.display="block",o.style.display="block",Je(),O(),s&&(window.location.href="/")):(e.style.display="none",t.style.display="block",n.style.display="none",o.style.display="none",s||(window.location.href="/login"))}function at(){var a,i;document.getElementById("logoutBtn").addEventListener("click",()=>{localStorage.removeItem("access_token"),localStorage.removeItem("authToken"),localStorage.removeItem("username"),ne=null,fe=null,be(),p("Logged out successfully","success"),U.navigate("/")});const e=document.getElementById("projectsSearch");e&&e.addEventListener("input",l=>{const d=l.target.value.toLowerCase();z=_.filter(c=>c.name.toLowerCase().includes(d)||c.repository&&c.repository.toLowerCase().includes(d)),X(z)});const t=document.getElementById("addProjectBtn");t&&t.addEventListener("click",()=>{window.router&&window.router.navigate("/deploy")});const n=document.getElementById("browseUploadLink");n&&n.addEventListener("click",l=>{l.preventDefault(),window.router&&window.router.navigate("/deploy")}),document.getElementById("newDeployBtn").addEventListener("click",()=>{r=null;const l=document.getElementById("projectSidebar");l&&(l.style.display="none");const d=document.getElementById("sidebar");d&&(d.style.display="block"),hn()});const o=document.getElementById("deployForm");o&&o.addEventListener("submit",Ft),_t();const s=document.getElementById("deploy-type");s&&s.addEventListener("change",l=>{const d=document.getElementById("single-repo-group"),c=document.getElementById("git-url-section"),m=document.getElementById("split-deploy-layout"),u=document.getElementById("git-url");l.target.value==="split"?(d&&(d.style.display="none"),c&&(c.style.display="none"),m&&(m.style.display="block"),u&&u.removeAttribute("required")):(d&&(d.style.display="block"),c&&(c.style.display="block"),m&&(m.style.display="none"),u&&u.setAttribute("required","required"))}),(a=document.getElementById("clearHistoryBtn"))==null||a.addEventListener("click",Ht),(i=document.getElementById("searchReposBtn"))==null||i.addEventListener("click",Ge),it(),lt()}function it(){const e=document.querySelector(".search-input"),t=document.getElementById("spotlightModal"),n=document.getElementById("spotlightSearch"),o=document.getElementById("spotlightResults");!e||!t||!n||!o||(e.addEventListener("click",rt),t.addEventListener("click",s=>{s.target===t&&Ie()}),n.addEventListener("input",ct),o.addEventListener("click",pt),document.addEventListener("keydown",s=>{s.key==="Escape"&&t.style.display!=="none"&&Ie()}))}function rt(){const e=document.getElementById("spotlightModal"),t=document.getElementById("spotlightSearch");e.style.display="flex",setTimeout(()=>{t.focus()},100)}function Ie(){const e=document.getElementById("spotlightModal"),t=document.getElementById("spotlightSearch"),n=document.getElementById("spotlightResults");e.style.display="none",t.value="",n.innerHTML=`
  ...
  `}function lt(){const e=document.getElementById("domainWarningModal");if(!e||e.dataset.bound==="true")return;e.dataset.bound="true";const t=document.getElementById("domainModalCancelBtn"),n=document.getElementById("domainModalOpenConfigBtn"),o=()=>{e.style.display="none"};t&&t.addEventListener("click",o),n&&n.addEventListener("click",()=>{o(),Le("domain-config"),Oe()}),e.addEventListener("click",s=>{s.target===e&&o()})}function ct(e){const t=e.target.value.toLowerCase().trim(),n=document.getElementById("spotlightResults");if(!t){n.innerHTML=`
    ...
    `),n+="</div>",t.innerHTML=n}function pt(e){const t=e.target.closest(".suggestion-item, .search-result-item");if(!t)return;const n=t.dataset.action,o=t.dataset.type,s=t.dataset.id;if(Ie(),o==="project"&&s)Ce(parseInt(s));else if(n)switch(n){case"new-deploy":window.router&&window.router.navigate("/deploy");break;case"repositories":window.router&&window.router.navigate("/repositories");break;case"history":window.router&&window.router.navigate("/history");break;case"domain":window.router&&window.router.navigate("/domain");break;case"settings":window.router&&window.router.navigate("/settings");break;case"projects":window.router&&window.router.navigate("/projects");break}}function ut(){document.getElementById("page-domain")}let ce=null;async function Se(){if(!(localStorage.getItem("access_token")||localStorage.getItem("authToken"))){const t=document.getElementById("vmStatusCard");t&&(t.style.display="none");return}try{const t=await fetch("/api/vm-status",{headers:N()});if(!t.ok){if(t.status===401){const o=document.getElementById("vmStatusCard");o&&(o.style.display="none");return}throw new Error("Failed to fetch VM status")}const n=await t.json();yt(n.vm_status,n.message),n.vm_status==="creating"?ce||(ce=setInterval(()=>{Se()},5e3)):ce&&(clearInterval(ce),ce=null)}catch(t){console.error("Error loading VM status:",t);const n=document.getElementById("vmStatusCard");n&&(n.style.display="none")}}function yt(e,t){Me("vmStatusCard","vmStatusBadge","vmStatusDot","vmStatusText","vmStatusMessage","vmStatusDetails","dashboardActions",e,t),Me("vmStatusCardProjects","vmStatusBadgeProjects","vmStatusDotProjects","vmStatusTextProjects","vmStatusMessageProjects","vmStatusDetailsProjects",null,e,t)}function Me(e,t,n,o,s,a,i,l,d){const c=document.getElementById(e),m=document.getElementById(t),u=document.getElementById(n),y=document.getElementById(o),f=document.getElementById(s),g=document.getElementById(a),v=i?document.getElementById(i):null;c&&(c.style.display="block",f&&(f.textContent=d),l==="creating"?(m&&(m.className="status-badge creating"),u&&(u.className="status-dot creating"),y&&(y.textContent="Creating"),g&&(g.style.display="block",g.textContent="Estimated time remaining: 2-5 minutes"),v&&(v.style.display="none")):l==="ready"?(m&&(m.className="status-badge running"),u&&(u.className="status-dot running"),y&&(y.textContent="Running"),g&&(g.style.display="none"),v&&(v.style.display="grid")):l==="failed"?(m&&(m.className="status-badge failed"),u&&(u.className="status-dot failed"),y&&(y.textContent="Failed"),g&&(g.style.display="block",g.textContent="Please check that OrbStack is installed and running, then try again."),v&&(v.style.display="grid")):(m&&(m.className="status-badge creating"),u&&(u.className="status-dot creating"),y&&(y.textContent="Checking"),g&&(g.style.display="none"),v&&(v.style.display="none")))}function N(){const e={},t=localStorage.getItem("access_token")||localStorage.getItem("authToken");return t&&(e.Authorization=`Bearer ${t}`),e}let _=[],z=[];async function O(){const e=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!e){X([]);return}ft();try{const t=await fetch("/deployments",{headers:{Authorization:`Bearer ${e}`}});t.ok?(_=(await t.json()).map(o=>{var G;const s=o.git_url||"",a=s,i=s?(G=String(s).split("/").pop())==null?void 0:G.replace(/\.git$/,""):null,l=o.app_name||i||o.container_name||"Untitled Project",d=(o.status||"").toLowerCase();let c;d==="running"?c="running":d==="failed"||d==="error"?c="failed":c="imported";let m=!1,u="single",y=null,f=null;const g=String(o.git_url||""),v=g.startsWith("split::"),S=!o.parent_project_id&&!o.component_type;if(v){m=!0,u="split";try{const $=g.replace("split::","").split("|");$.length===2&&(y=$[0],f=$[1])}catch{}}else if(d==="imported_split")m=!0,u="split";else if(S&&g.includes("|")){m=!0,u="split";try{const $=g.split("|");$.length===2&&(y=$[0],f=$[1])}catch{}}const J=o.custom_domain&&o.domain_status&&o.domain_status.toLowerCase()==="active"?`https://${o.custom_domain}`:o.deployed_url||o.app_url||null;return{id:o.id,name:l,status:c,url:J,createdAt:o.created_at,updatedAt:o.updated_at,repository:a,repository_url:a,git_url:s,project_type:u,isSplit:m,frontend_url:y,backend_url:f,processPid:o.process_pid||null,port:o.port||null,startCommand:o.start_command||null,buildCommand:o.build_command||null,isRunning:o.is_running||!1,custom_domain:o.custom_domain||null,domain_status:o.domain_status||null,last_domain_sync:o.last_domain_sync||null}}),z=[..._],X(z)):X([])}catch(t){console.error("Error loading projects:",t),X([])}}function X(e){const t=document.getElementById("projectsGrid");if(t){if(e.length===0){t.innerHTML=`
    ...
    `;return}t.innerHTML=e.map(n=>{const o=n.status==="running"?"status-success":n.status==="failed"?"status-error":"status-info",s=n.status==="running"?"Running":n.status==="failed"?"Failed":"Imported",a=n.status==="running"?"🚀":"📦",i=n.updatedAt?ee(n.updatedAt):"Recently";return`
      ...
      `}).join("")}}async function gt(e){try{const t=_.find(o=>o.id===e);if(!t){p("Project not found","error");return}const n=ze(t.url);if(!n){p("Project URL not available. Make sure the project is deployed.","error");return}window.open(n,"_blank"),p(`Opening ${t.name}...`,"info")}catch(t){console.error("Error opening project site:",t),p("Failed to open project site: "+t.message,"error")}}function ft(){const e=document.getElementById("projectsGrid");e&&(e.innerHTML=`
  ...
  `)}let r=null;function Ce(e){O().then(()=>{const n=_.find(o=>o.id==e);if(!n){const o=z.find(s=>s.id==e);o&&(r=o,xe(o));return}r=n,xe(n)});const t=document.getElementById("page-project-config");t&&t.style.display!=="none"&&$e()}function xe(e){const t=document.getElementById("sidebar");t&&(t.style.display="none");let n=document.getElementById("projectSidebar");n||(n=vt(),document.body.appendChild(n));const o=n.querySelector("#projectSidebarName");o&&(o.textContent=e.name);const s=n.querySelector("#projectSidebarId");s&&(s.textContent=e.id);const a=n.querySelector('a[data-project-page="status"]');a&&(e.project_type==="split"?a.style.display="flex":a.style.display="none"),n.style.display="block",document.getElementById("pageTitle").textContent=e.name,We(),Le("deploy")}function vt(){const e=document.createElement("aside");return e.id="projectSidebar",e.className="sidebar project-sidebar",e.innerHTML=`
  ...
  `,e.querySelectorAll(".project-nav-item").forEach(t=>{t.addEventListener("click",async n=>{n.preventDefault();const o=t.getAttribute("data-project-page");if(await O(),r){const s=_.find(a=>a.id===r.id);s&&(r=s)}Le(o),e.querySelectorAll(".project-nav-item").forEach(s=>s.classList.remove("active")),t.classList.add("active")})}),e}function ht(){const e=document.getElementById("projectSidebar");e&&(e.style.display="none");const t=document.getElementById("sidebar");t&&(t.style.display="block"),r=null,document.getElementById("pageTitle").textContent="Projects",document.querySelectorAll(".page").forEach(o=>{o.style.display="none"});const n=document.getElementById("page-projects");n&&(n.style.display="block"),O()}function Le(e){switch(document.querySelectorAll(".page").forEach(t=>{t.style.display="none"}),e){case"deploy":const t=document.getElementById("page-deploy");if(t){t.style.display="block";const o=document.getElementById("deploy-status"),s=document.getElementById("deploy-success");o&&(o.textContent="",o.style.color=""),s&&(s.style.display="none");const a=document.getElementById("deploy-page-title"),i=document.getElementById("deploy-card-title"),l=document.getElementById("deploy-description");if(r){a&&(a.textContent=r.name||"Project"),i&&(i.textContent=r.name||"Project"),l&&(l.textContent="Update deployment settings and redeploy your project.");const w=document.getElementById("import-info"),L=document.getElementById("import-repo-name"),T=r.git_url||r.repository_url||"",x=document.getElementById("git-url");if(x&&T&&(x.value=T,console.log("Populated Git URL input in showProjectContent:",T),x.removeAttribute("required")),T&&w&&L)try{const E=T.match(/github\.com[/:]([^/]+)\/([^/]+?)(?:\.git|[/]|$)/);if(E){const B=E[1],j=E[2];L.textContent=`${B}/${j}`,w.style.display="flex";const I=document.getElementById("branch-badge"),F=document.getElementById("branch-name");I&&F&&(I.style.display="flex",F.textContent="main")}}catch(E){console.warn("Failed to parse GitHub URL:",E)}else w&&(w.style.display="none");console.log("showProjectContent - currentProject:",{id:r.id,name:r.name,git_url:r.git_url,repository_url:r.repository_url,gitUrl:T}),Mt(r.id,T)}else{a&&(a.textContent="New Project"),i&&(i.textContent="New Project"),l&&(l.textContent="Choose where you want to create the project and give it a name.");const w=document.getElementById("import-info");w&&(w.style.display="none")}const d=document.getElementById("project-components-section");d&&(d.style.display="none"),document.getElementById("deploy-type");const c=document.getElementById("deploy-type-group"),m=document.getElementById("single-repo-group"),u=document.getElementById("git-url-section"),y=document.getElementById("split-deploy-layout"),f=document.getElementById("git-url"),g=document.getElementById("project-name"),v=document.getElementById("framework-preset"),S=document.getElementById("root-directory"),W=document.getElementById("install-command"),J=document.getElementById("build-command"),G=document.getElementById("start-command"),$=document.getElementById("port"),M=document.getElementById("frontend-url"),h=document.getElementById("backend-url"),C=document.getElementById("deploy-submit-default"),ie=document.getElementById("edit-root-directory-btn");ie&&S&&(ie.onclick=()=>{S.removeAttribute("readonly"),S.focus(),S.select()});let D=r==null?void 0:r.project_type;const re=(r==null?void 0:r.git_url)||(r==null?void 0:r.repository_url)||"",oe=re.startsWith("split::");if(D||(r!=null&&r.isSplit||oe?D="split":D="single"),oe&&D!=="split"?D="split":!oe&&D==="split"&&re&&(D="single"),r){if(c&&(c.style.display="none"),g&&(g.value=r.name||r.app_name||""),v){const w=r.buildCommand||r.build_command||"",L=r.startCommand||r.start_command||"";w.includes("next build")||L.includes("next start")?v.value="nextjs":w.includes("react-scripts")||L.includes("react-scripts")?v.value="react":L.includes("vue")||w.includes("vue")?v.value="vue":L.includes("flask")||w.includes("flask")?v.value="flask":L.includes("django")||w.includes("django")?v.value="django":L.includes("python")||w.includes("python")?v.value="python":L.includes("node")||w.includes("npm")?v.value="nodejs":v.value="auto"}if(S&&(S.value="./"),J&&(J.value=r.buildCommand||r.build_command||""),G&&(G.value=r.startCommand||r.start_command||""),$&&($.value=r.port||""),W&&!W.value){const w=(v==null?void 0:v.value)||"auto";["nextjs","react","vue","nodejs"].includes(w)?W.placeholder="npm install":["python","flask","django"].includes(w)&&(W.placeholder="pip install -r requirements.txt")}if(D==="split"){m&&(m.style.display="none"),y&&(y.style.display="block"),M&&(M.value=r.frontend_url||""),h&&(h.value=r.backend_url||""),f&&f.removeAttribute("required"),C&&(C.style.display="none");const w=document.getElementById("deploy-frontend-btn"),L=document.getElementById("deploy-backend-btn"),T=document.getElementById("deploy-both-btn");w&&(w.onclick=async()=>{var j,I,F,Y;const x=(j=M==null?void 0:M.value)==null?void 0:j.trim();if(!x||!x.startsWith("http"))return p("Enter a valid frontend URL","error");const E=Ee(!1);document.getElementById("step-frontend").style.display="flex",E.updateFrontendStatus("deploying","Deploying your frontend now..."),(I=document.getElementById("build-command"))!=null&&I.value.trim(),(F=document.getElementById("start-command"))!=null&&F.value.trim(),(Y=document.getElementById("port"))!=null&&Y.value.trim();const B=await Re(x,"frontend",E,!0);B&&B.success&&B.deployed_url?(E.showUrls(B.deployed_url,null),document.getElementById("close-deployment-dialog").onclick=()=>{E.close(),ge(),me()}):B&&!B.success&&setTimeout(()=>E.close(),3e3)}),L&&(L.onclick=async()=>{var j,I,F,Y;const x=(j=h==null?void 0:h.value)==null?void 0:j.trim();if(!x||!x.startsWith("http"))return p("Enter a valid backend URL","error");const E=Ee(!1);document.getElementById("step-backend").style.display="flex",E.updateBackendStatus("deploying","Deploying your backend now..."),(I=document.getElementById("build-command"))!=null&&I.value.trim(),(F=document.getElementById("start-command"))!=null&&F.value.trim(),(Y=document.getElementById("port"))!=null&&Y.value.trim();const B=await Re(x,"backend",E,!0);B&&B.success&&B.deployed_url?(E.showUrls(null,B.deployed_url),document.getElementById("close-deployment-dialog").onclick=()=>{E.close(),ge(),me()}):B&&!B.success&&setTimeout(()=>E.close(),3e3)}),T&&(T.onclick=async()=>{var F,Y;const x=(F=M==null?void 0:M.value)==null?void 0:F.trim(),E=(Y=h==null?void 0:h.value)==null?void 0:Y.trim();if(!x||!x.startsWith("http")||!E||!E.startsWith("http")){p("Please enter valid Frontend and Backend repository URLs","error");return}let B=!1,j={};if(r&&r.id)try{const k=await fetch(`/api/env-vars?project_id=${r.id}`,{headers:N()});if(k.ok){const K=(await k.json()).variables||{};B=Object.keys(K).length>0,console.log("Existing env vars check:",{hasExistingEnvVars:B,count:Object.keys(K).length})}}catch(k){console.warn("Failed to check existing env vars:",k)}if(B){await I();return}try{const k=await fetch(`/api/env-vars/detect?frontend_url=${encodeURIComponent(x)}&backend_url=${encodeURIComponent(E)}`,{headers:N()});k.ok?(j=(await k.json()).suggestions||{},console.log("Env var detection result:",{count:Object.keys(j).length,vars:j})):console.warn("Env var detection API returned:",k.status)}catch(k){console.warn("Env var detection failed:",k)}Lt(j,async()=>{if(Object.keys(j).length===0){r&&r.id?U.navigate("/env-vars"):(p("No env vars detected. Add them manually after deployment","info"),await I());return}if(p("Importing environment variables...","info"),r&&r.id){const k={};Object.keys(j).forEach(le=>{k[le]=""});const Q=localStorage.getItem("access_token")||localStorage.getItem("authToken"),K=await fetch(`/api/env-vars?project_id=${r.id}`,{headers:{Authorization:`Bearer ${Q}`}});if(K.ok){const pe={...(await K.json()).variables||{},...k};(await fetch("/api/env-vars",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${Q}`},body:JSON.stringify({variables:pe,project_id:r.id})})).ok?(p("Environment variables imported successfully!","success"),setTimeout(()=>I(),500)):(p("Failed to import environment variables","error"),await I())}else p("Failed to load existing environment variables","error"),await I()}else p("Save detected env vars after deployment","info"),await I()},()=>{r&&r.id?U.navigate("/env-vars"):p("Please add environment variables after deployment","info")},async()=>{await I()});async function I(){var Q,K,le;const k=Ee(!0);document.getElementById("step-backend").style.display="flex",document.getElementById("step-frontend").style.display="flex",k.updateBackendStatus("deploying","Deploying your backend now...");try{const R=new FormData;R.append("deploy_type","split"),R.append("frontend_url",x),R.append("backend_url",E),r&&r.id&&R.append("project_id",String(r.id));const pe=(Q=document.getElementById("build-command"))==null?void 0:Q.value.trim(),we=(K=document.getElementById("start-command"))==null?void 0:K.value.trim(),Ae=(le=document.getElementById("port"))==null?void 0:le.value.trim();pe&&R.append("build_command",pe),we&&R.append("start_command",we),Ae&&R.append("port",Ae);const Ue=await fetch("/deploy",{method:"POST",headers:N(),body:R}),ue=await Ue.json();Ue.ok&&ue.deployed_url?(k.updateBackendStatus("success","Backend deployed! ✅"),k.updateFrontendStatus("success","Frontend deployed! ✅"),k.showUrls(ue.deployed_url,null),document.getElementById("close-deployment-dialog").onclick=()=>{k.close(),O(),ge(),me()},p("Split deployment successful!","success")):(k.updateBackendStatus("failed",ue.detail||"Deployment failed"),k.updateFrontendStatus("failed","Could not deploy"),p(ue.detail||"Deployment failed","error"),setTimeout(()=>k.close(),3e3))}catch{k.updateBackendStatus("failed","Network error"),k.updateFrontendStatus("failed","Network error"),p("Network error during deployment","error"),setTimeout(()=>k.close(),3e3)}}}),C&&(C.style.display="none")}else if(D==="single"){if(m&&(m.style.display="block"),u&&(u.style.display="none"),y&&(y.style.display="none"),f&&r){const w=r.git_url||r.repository_url||"";w&&(f.value=w,f.removeAttribute("required"))}C&&(C.textContent="Deploy",C.style.display="")}}else c&&(c.style.display=""),splitGroup&&(splitGroup.style.display="none"),y&&(y.style.display="none"),m&&(m.style.display="block"),f&&(f.value=""),C&&(C.textContent="🚀 Deploy",C.style.display="")}document.getElementById("pageTitle").textContent="Deploy";break;case"status":jt();break;case"configuration":xt();break;case"domain-config":Oe();break;case"env-vars":const n=document.getElementById("page-env-vars");n&&(n.style.display="block",De());break;case"logs":bt();break;case"files":document.getElementById("pageTitle").textContent="Repository Files",Et();break}}async function bt(){document.querySelectorAll(".page").forEach(t=>t.style.display="none");let e=document.getElementById("page-project-logs");e||(e=document.createElement("div"),e.id="page-project-logs",e.className="page",document.getElementById("pageContent").appendChild(e)),e.innerHTML="",e.innerHTML=`
    <div class="card">
  ...
  `,e.style.display="block",r&&r.id&&(wt(r.id),Xe(r.id))}async function wt(e){var t;try{const n=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!n){console.warn("No authentication token found");return}const o=await fetch(`/projects/${e}/logs`,{headers:{Authorization:`Bearer ${n}`}});if(!o.ok){const i=await o.text();throw console.error("Failed to load logs:",o.status,i),new Error(`Failed to load logs: ${o.status} ${o.statusText}`)}const s=await o.json();console.log("Loaded saved logs:",((t=s.logs)==null?void 0:t.length)||0,"logs");const a=document.getElementById("projectLogsContent");if(!a){console.warn("projectLogsContent element not found");return}a.querySelector("p")&&(a.innerHTML=""),s.logs&&Array.isArray(s.logs)&&s.logs.length>0?(console.log("Displaying",s.logs.length,"saved logs"),s.logs.forEach(i=>{q(i.message,i.type||"info")})):(console.log("No saved logs found, showing waiting message"),q("No saved logs found. Waiting for new deployment logs...","info"))}catch(n){console.error("Error loading saved logs:",n);const o=document.getElementById("projectLogsContent");o&&(o.children.length===0||o.querySelector("p"))&&q(`Error loading saved logs: ${n.message}`,"error")}}async function Et(){document.querySelectorAll(".page").forEach(s=>s.style.display="none");let e=document.getElementById("page-project-files");if(e||(e=document.createElement("div"),e.id="page-project-files",e.className="page",document.getElementById("pageContent").appendChild(e)),!r||!r.git_url){e.innerHTML=`
      <div class="card">
        <div class="page-header">
  ...
  `,e.style.display="block",e.dataset.projectId=r.id,e.dataset.useVm="true",e.dataset.currentPath="",setTimeout(()=>{const s=document.getElementById("filesBackButton");s?(s.replaceWith(s.cloneNode(!0)),document.getElementById("filesBackButton").addEventListener("click",window.goBackInFiles),console.log("Back button event listener attached")):console.error("Back button not found")},100),await de("")}async function de(e){const t=document.getElementById("page-project-files");if(!t)return;const n=t.dataset.useVm==="true",o=t.dataset.projectId,s=t.dataset.owner,a=t.dataset.repo;if(n&&!o){p("Project ID not found","error");return}if(!n&&(!s||!a)){p("Repository information not found","error");return}const i=document.getElementById("filesTreeContainer"),l=document.getElementById("filesTreeLoading"),d=document.getElementById("fileContentContainer");l&&(l.style.display="flex"),i&&(i.style.display="none"),d&&(d.innerHTML=`
    ...
    `,a.onclick=()=>{if(s.type==="dir"){const l=document.getElementById("page-project-files");l&&(l.dataset.currentPath=s.path),de(s.path)}else Bt(s)},n.appendChild(a)})}async function Bt(e){const t=document.getElementById("page-project-files");if(!t)return;const n=t.dataset.useVm==="true",o=t.dataset.projectId,s=t.dataset.owner,a=t.dataset.repo;if(n&&!o){p("Project ID not found","error");return}if(!n&&(!s||!a)){p("Repository information not found","error");return}const i=document.getElementById("fileContentContainer");if(i){i.innerHTML=`
  ...
  `;try{const l=localStorage.getItem("access_token")||localStorage.getItem("authToken"),d={"Content-Type":"application/json"};l&&(d.Authorization=`Bearer ${l}`);let c;n?c=`/projects/${o}/files/content?file_path=${encodeURIComponent(e.path)}`:c=`/api/repository/${s}/${a}/contents/${e.path}`,console.log("Loading file content from:",c);const m=await fetch(c,{headers:d});if(m.status===401){p("Authentication required","error");return}if(!m.ok){const v=await m.json().catch(()=>({detail:"Unknown error"}));console.error("File content error:",m.status,v),p(v.detail||"Failed to load file content","error"),i.innerHTML=`
      ...
      `;return}const u=await m.json();if(u.is_binary||u.encoding==="binary"){const v=u.size||0;i.innerHTML=`
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; padding-bottom: 0.5rem; border-bottom: 1px solid var(--border-color);">
          ...
          <div style="color: var(--text-secondary); font-size: 0.9rem;">${Fe(v)}</div>
        </div>
        <div style="text-align: center; padding: 3rem; color: var(--text-secondary);">
          <div style="font-size: 3rem; margin-bottom: 1rem; opacity: 0.5;">📄</div>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; padding-bottom: 0.5rem; border-bottom: 1px solid var(--border-color);">
        <div style="font-weight: 600; font-size: 1.1rem;">${b(e.name)}</div>
        <div style="color: var(--text-secondary); font-size: 0.9rem;">${Fe(g)}</div>
      </div>
    ...
    `}}}function It(e,t){const n=document.getElementById("filesBreadcrumb"),o=document.getElementById("filesBackButton");if(!n)return;if(o&&(e&&e.split("/").filter(l=>l).length>0?(o.style.display="block",o.hasAttribute("data-listener-attached")||(o.addEventListener("click",window.goBackInFiles),o.setAttribute("data-listener-attached","true"),console.log("Back button listener attached in updateFilesBreadcrumb"))):o.style.display="none"),!e){n.innerHTML=`<span class="breadcrumb-item" onclick="loadFilesPath('')">${b(t)}</span>`;return}const s=e.split("/").filter(l=>l);let a=`<span class="breadcrumb-item" onclick="loadFilesPath('')">${b(t)}</span>`,i="";s.forEach((l,d)=>{i+=(d>0?"/":"")+l,a+=`
    ...
    `}),n.innerHTML=a}window.goBackInFiles=function(){console.log("goBackInFiles called");const e=document.getElementById("page-project-files");if(!e){console.error("Files page not found");return}const t=e.dataset.currentPath||"";if(console.log("Current path:",t),!t||t===""){console.log("Already at root, staying at root"),de("");return}const n=t.split("/").filter(o=>o);if(console.log("Path parts:",n),n.length>0){n.pop();const o=n.join("/");console.log("Going back to parent path:",o),de(o)}else console.log("Going back to root"),de("")};function St(e){const t=e.split(".").pop().toLowerCase();return{js:"📄",jsx:"📄",ts:"📄",tsx:"📄",py:"🐍",java:"☕",cpp:"⚙️",c:"⚙️",html:"🌐",css:"🎨",scss:"🎨",sass:"🎨",json:"📋",xml:"📋",yml:"📋",yaml:"📋",md:"📝",txt:"📝",sql:"🗄️",sh:"🐚",bat:"🪟",dockerfile:"🐳",gitignore:"🚫"}[t]||"📄"}function Fe(e){if(e===0)return"0 Bytes";const t=1024,n=["Bytes","KB","MB","GB"],o=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,o)).toFixed(2))+" "+n[o]}async function xt(){let e=document.getElementById("page-project-config");e||(e=document.createElement("div"),e.id="page-project-config",e.className="page",e.innerHTML=`
      <div class="card">
        ...
        <div class="config-info-grid">
          ...
          <div class="config-row">
            ...
            <div class="config-value-container">
              <span class="config-value-text" id="projectConfigCreated">${r!=null&&r.createdAt?Pe(r.createdAt):"Unknown"}</span>
            </div>
          </div>
          <div class="config-row">
    ...
    `,requestAnimationFrame(()=>{d.classList.add("components-visible");const S=c.querySelector(".card:not(#project-components-section)");S&&S.classList.add("deploy-card-slide-down")})}else if(d){d.style.display="none",d.classList.remove("components-visible");const y=c==null?void 0:c.querySelector(".card:not(#project-components-section)");y&&y.classList.remove("deploy-card-slide-down")}}catch(e){console.error("Error loading project components:",e)}}function ze(e){if(!e||e==="#")return null;const t=e.trim();return/^https?:\/\//i.test(t)?t:`https://${t}`}function Ct(e){const t=ze(e);t?window.open(t,"_blank"):p("Site URL is unavailable","error")}function Lt(e,t,n,o){const s=document.createElement("div");s.className="modal-overlay",s.id="envVarsDetectionOverlay";const a=document.createElement("div");a.className="modal-content enhanced",a.style.maxWidth="600px";const i=Object.keys(e).length>0,l=i?Object.entries(e).map(([c,m])=>`
  ...
  `,s.appendChild(a),document.body.appendChild(s),document.querySelector(".skip-env-btn").onclick=()=>{s.remove(),o&&o()},document.querySelector(".add-manual-env-btn").onclick=()=>{s.remove(),n&&n()};const d=document.querySelector(".import-env-btn");return d&&(d.onclick=async()=>{s.remove(),t&&await t()}),s}function Ee(e=!0){const t=document.createElement("div");t.className="modal-overlay deployment-progress-overlay",t.id="deploymentProgressOverlay";const n=document.createElement("div");return n.className="deployment-progress-modal",n.innerHTML=`
  ...
  `,e.appendChild(t),document.body.appendChild(e);const n=document.getElementById("newProjectNameInput");n&&(n.focus(),n.select());const o=t.querySelector(".cancel-name-btn"),s=t.querySelector(".save-name-btn"),a=()=>{document.body.removeChild(e)};o.onclick=()=>{a()},s.onclick=async()=>{const l=n.value.trim();if(!l){p("Project name cannot be empty","error");return}if(l===r.name){a();return}try{const d=localStorage.getItem("access_token")||localStorage.getItem("authToken"),c=await fetch(`/projects/${r.id}/name`,{method:"PUT",headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:`Bearer ${d}`},body:new URLSearchParams({app_name:l})}),m=await c.json();if(c.ok){p("Project name updated successfully!","success"),r.name=l,a();const u=_.findIndex(f=>f.id===r.id);u>=0&&(_[u].name=l),$e(),X(z);const y=document.getElementById("projectSidebarName");y&&(y.textContent=l),document.getElementById("pageTitle").textContent=l}else p(m.detail||"Failed to update project name","error")}catch(d){console.error("Error updating project name:",d),p("Failed to update project name: "+d.message,"error")}},e.onclick=l=>{l.target===e&&a()};const i=l=>{l.key==="Escape"&&(a(),document.removeEventListener("keydown",i))};document.addEventListener("keydown",i)}function $t(e){const t=document.getElementById("content"+e.charAt(0).toUpperCase()+e.slice(1)),n=document.getElementById("icon"+e.charAt(0).toUpperCase()+e.slice(1));t&&n&&(t.classList.toggle("active"),n.classList.toggle("active"))}function Pt(){r&&r.id?typeof U<"u"&&U&&U.navigate?U.navigate("/env-vars"):window.router&&window.router.navigate?window.router.navigate("/env-vars"):window.location.hash="#/env-vars":p("Please create a project first before adding environment variables","info")}function _t(){const e=document.getElementById("framework-preset"),t=document.getElementById("install-command"),n=document.getElementById("build-command"),o=document.getElementById("start-command");e&&e.addEventListener("change",function(s){const a=s.target.value;if(t&&(["nextjs","react","vue","nuxt","gatsby","angular","svelte","vite","nodejs"].includes(a)?t.placeholder="npm install, yarn install, or pnpm install":["python","flask","django"].includes(a)?t.placeholder="pip install -r requirements.txt":t.placeholder="npm install, yarn install, pnpm install, or pip install -r requirements.txt"),n){const i={nextjs:"next build",react:"npm run build",vue:"npm run build",nuxt:"nuxt build",gatsby:"gatsby build",angular:"ng build",svelte:"npm run build",vite:"vite build",nodejs:"npm run build",python:"",flask:"",django:"python manage.py collectstatic --noinput",static:""};i[a]&&(n.placeholder=i[a]||"Leave empty for auto-detect")}if(o){const i={nextjs:"npm run start",react:"npm start",vue:"npm run serve",nuxt:"nuxt start",gatsby:"gatsby serve",angular:"ng serve",svelte:"npm run dev",vite:"vite preview",nodejs:"node server.js",python:"python app.py",flask:"flask run",django:"python manage.py runserver",static:"python -m http.server"};i[a]&&(o.placeholder=i[a]||"Leave empty for auto-detect")}})}window.toggleDeploySection=$t;window.navigateToEnvVars=Pt;function $e(){if(!r)return;const e=document.getElementById("projectConfigName"),t=document.getElementById("projectConfigOwner"),n=document.getElementById("projectConfigId"),o=document.getElementById("projectConfigCreated"),s=document.getElementById("projectConfigUpdated"),a=document.getElementById("projectConfigPort"),i=document.getElementById("projectConfigPid"),l=document.getElementById("projectConfigStartCommand"),d=document.getElementById("projectConfigBuildCommand");if(e&&(e.textContent=r.name||"Unknown"),t){const c=localStorage.getItem("username"),m=localStorage.getItem("displayName");t.textContent=m||c||"Unknown User"}n&&(n.textContent=r.id||"-"),o&&(o.textContent=r.createdAt?Pe(r.createdAt):"Unknown"),s&&(s.textContent=r.updatedAt?ee(new Date(r.updatedAt)):"Unknown"),a&&(a.textContent=(r==null?void 0:r.port)||"Not set"),i&&(i.textContent=(r==null?void 0:r.processPid)||"Not running"),l&&(l.textContent=(r==null?void 0:r.startCommand)||"Not set"),d&&(d.textContent=(r==null?void 0:r.buildCommand)||"Not set")}function Oe(){let e=document.getElementById("page-project-domain");e||(e=document.createElement("div"),e.id="page-project-domain",e.className="page",e.innerHTML=`
      <div class="card">
    ...
    `,document.getElementById("pageContent").appendChild(e)),e.style.display="block",Dt(),ve()}function Dt(){const e=document.getElementById("saveDomainBtn");e&&!e.dataset.bound&&(e.dataset.bound="true",e.addEventListener("click",Nt))}function Tt(e,t){if(!e)return;if(!t||!t.custom_domain){e.innerHTML='<span class="status-muted">No custom domain configured yet.</span>';return}const n=(t.domain_status||"unknown").toLowerCase(),o=t.last_domain_sync?Pe(t.last_domain_sync):"Never";let s="Unknown",a="status-info",i="";n==="active"?(s="Active",a="status-success"):n==="error"?(s="Error",a="status-error",i="Resolve the issue and save the domain again."):n==="pending"&&(s="Pending",a="status-warning",i="Domain will be activated automatically after the next successful deployment."),e.innerHTML=`
  ...
  `}async function ve(){const e=document.getElementById("domainSuggestion"),t=document.getElementById("domainStatus"),n=document.getElementById("domainPrefix"),o=document.getElementById("platformDomain");if(!r||!r.id){t&&(t.innerHTML='<span class="status-muted">Select a project to configure its domain.</span>');return}const s=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!s){t&&(t.innerHTML='<span class="status-error">Please login to manage domains.</span>');return}e&&(e.textContent="Loading domain details...");try{const a=await fetch(`/projects/${r.id}/domain`,{headers:{Authorization:`Bearer ${s}`}});if(!a.ok)throw new Error(`Failed to load domain info (${a.status})`);const i=await a.json(),l=i.butler_domain||"aayush786.xyz";o&&(o.textContent=l);let d="";const c=i.custom_domain||i.suggested_domain||"";if(c)if(c.endsWith(l))d=c.slice(0,-(l.length+1));else{const m=c.split(".");m.length>0&&(d=m[0])}if(n){n.value=d;const m=i.suggested_domain&&i.suggested_domain.endsWith(l)?i.suggested_domain.slice(0,-(l.length+1)):"";n.placeholder=m||"project-slug or my.project"}if(e){const m=i.suggested_domain&&i.suggested_domain.endsWith(l)?i.suggested_domain.slice(0,-(l.length+1)):"";e.textContent=m?`Suggested: ${m} (you can use multiple labels like "my.project" or "portfolio.app"). Leave blank to remove. Domains become active after a successful deploy.`:`Enter a subdomain prefix (can be multiple labels like "my.project" or "portfolio"). The platform domain ${l} is fixed and cannot be changed.`}Tt(t,i),r&&(r.custom_domain=i.custom_domain,r.domain_status=i.domain_status)}catch(a){console.error("Failed to load project domain info:",a),t&&(t.innerHTML='<span class="status-error">Could not load domain configuration.</span>')}}async function Nt(){if(!r||!r.id){p("Select a project first","error");return}const e=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!e){p("Please login to manage domains","error");return}const t=document.getElementById("domainPrefix"),n=document.getElementById("platformDomain");let o=t?t.value.trim():"";const s=n?n.textContent.trim():"";let a="";if(o){if(o=o.trim().replace(/^\.+|\.+$/g,""),!o){p("Please enter a subdomain prefix.","error");return}if(!/^[a-z0-9.-]+$/i.test(o)){p("Subdomain prefix can only contain letters, numbers, hyphens, and dots.","error");return}if(o.includes("..")){p("Subdomain prefix cannot contain consecutive dots.","error");return}if(o.startsWith(".")||o.endsWith(".")){p("Subdomain prefix cannot start or end with a dot.","error");return}a=`${o}.${s}`}if(!a){if(!r.custom_domain){p("Enter a subdomain prefix to save, or leave blank to remove the domain.","info");return}if(!confirm("Remove the custom domain and revert to the default internal URL?"))return;await At(),await ve();return}const i={custom_domain:a,auto_generate:!1};try{const l=await fetch(`/projects/${r.id}/domain`,{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify(i)});if(!l.ok){const m=(await l.json().catch(()=>({}))).detail||"Failed to save domain";if(l.status===409){p(m,"error");const y=document.getElementById("domainStatus");y&&(y.innerHTML=`<span class="status-error">${b(m)}</span>`)}else throw new Error(m);return}const d=await l.json();p(`Domain saved: ${d.custom_domain}`,"success"),await ve()}catch(l){console.error("Failed to save domain:",l),p(l.message||"Failed to save domain","error");const d=document.getElementById("domainStatus");d&&l.message&&(d.innerHTML=`<span class="status-error">${b(l.message)}</span>`)}}async function At(){if(!r||!r.id){p("Select a project first","error");return}const e=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!e){p("Please login to manage domains","error");return}try{const t=await fetch(`/projects/${r.id}/domain`,{method:"DELETE",headers:{Authorization:`Bearer ${e}`}});if(!t.ok){const o=(await t.json().catch(()=>({}))).detail||"Failed to reset domain";throw new Error(o)}p("Domain removed. Project will use its internal URL.","success"),r&&(r.custom_domain=null,r.domain_status=null),await ve()}catch(t){console.error("Failed to clear domain:",t),p(t.message||"Failed to clear domain","error")}}function Ut(e){Ce(e)}async function We(){const e=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!e){console.log("No auth token found");return}try{const t=await fetch("/api/user/profile",{headers:{Authorization:`Bearer ${e}`}});if(t.ok){const n=await t.json(),o=document.getElementById("projectSidebar");if(o){const s=o.querySelector("#projectSidebarUserName"),a=o.querySelector("#projectSidebarUserEmail"),i=o.querySelector("#projectSidebarUserAvatar");if(s&&(s.textContent=n.display_name||n.username||"User"),a&&(a.textContent=n.email||"No email"),i)if(n.avatar_url){const l=new Image;l.onload=()=>{i.style.backgroundImage=`url(${n.avatar_url})`,i.style.backgroundSize="cover",i.style.backgroundPosition="center",i.textContent=""},l.onerror=()=>{i.style.backgroundImage="",i.textContent=(n.display_name||n.username||"U").charAt(0).toUpperCase()},l.src=n.avatar_url}else i.style.backgroundImage="",i.textContent=(n.display_name||n.username||"U").charAt(0).toUpperCase()}}else console.error("Failed to load user profile:",t.status)}catch(t){console.error("Error loading user profile:",t)}}function ee(e){if(!e)return"Recently";const n=Date.now()-new Date(e).getTime(),o=Math.floor(n/6e4),s=Math.floor(n/36e5),a=Math.floor(n/864e5);if(o<1)return"Just now";if(o<60)return`${o}m ago`;if(s<24)return`${s}h ago`;if(a<7)return`${a}d ago`;const i=new Date(e);return i.toLocaleDateString("en-US",{month:"short",day:"numeric",year:i.getFullYear()!==new Date().getFullYear()?"numeric":void 0})}function Pe(e){return e?new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit",hour12:!0,timeZone:"Asia/Kathmandu"}):"Unknown"}async function Mt(e,t){const n=document.getElementById("monorepo-section"),o=document.getElementById("frontend-folder"),s=document.getElementById("backend-folder");if(!(!n||!o||!s))try{const a=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!a)return;const i=e?`/api/detect-monorepo?project_id=${e}`:`/api/detect-monorepo?git_url=${encodeURIComponent(t)}`,l=await fetch(i,{headers:{Authorization:`Bearer ${a}`}});if(l.ok){const d=await l.json();if(d.is_monorepo){if(n.style.display="block",d.frontend_folder){o.innerHTML='<option value="">None (skip frontend)</option>';const c=document.createElement("option");c.value=d.frontend_folder,c.textContent=d.frontend_folder,c.selected=!0,o.appendChild(c)}else o.innerHTML='<option value="">None (skip frontend)</option>';if(d.backend_folder){s.innerHTML='<option value="">None (skip backend)</option>';const c=document.createElement("option");c.value=d.backend_folder,c.textContent=d.backend_folder,c.selected=!0,s.appendChild(c)}else s.innerHTML='<option value="">None (skip backend)</option>'}else n.style.display="none"}}catch(a){console.error("Error detecting monorepo structure:",a),n.style.display="none"}}async function me(){await O();try{const e=await fetch("/deployments",{headers:N()});if(e.ok){const t=await e.json();document.getElementById("totalDeployments").textContent=t.length,document.getElementById("runningApps").textContent=t.filter(o=>o.status==="success").length;const n=document.getElementById("recentActivity");t.length>0?n.innerHTML=t.slice(0,5).map(o=>{const s=o.app_name||o.container_name||"Untitled Project";return`
    ...
    `;return}try{const e=await fetch("/deployments",{headers:N()});if(e.ok){const t=await e.json(),n=document.getElementById("historyTableBody");t.length===0?n.innerHTML=`
        ...
        `}).join("")}}catch(e){console.error("Error loading history:",e)}}async function Ht(){if(confirm("Are you sure you want to clear all deployment history?"))try{(await fetch("/deployments/clear",{method:"DELETE",headers:N()})).ok&&(p("History cleared successfully","success"),_e())}catch{p("Error clearing history","error")}}async function Vt(e){if(confirm(`Are you sure you want to destroy "${e}"?`))try{(await fetch(`/deployments/${e}`,{method:"DELETE",headers:N()})).ok?(p("Deployment destroyed successfully","success"),_e(),Rt()):p("Error destroying deployment","error")}catch{p("Network error","error")}}let P=[],He="";async function Ge(){const e=document.getElementById("usernameSearch").value.trim();if(!e){p("Please enter a GitHub username","error");return}e!==He&&(P=[],He=e);const t=document.getElementById("repositoriesGrid");t.innerHTML='<div class="empty-state"><p>Loading repositories...</p></div>';try{const n=await fetch(`/api/repositories/${e}`),o=await n.json();if(n.ok&&o.repositories)if(o.repositories.length===0)t.innerHTML='<div class="empty-state"><p>No repositories found</p></div>';else{try{localStorage.setItem("repos.lastUsername",e),localStorage.setItem("repos.lastData",JSON.stringify(o.repositories))}catch{}t.innerHTML=o.repositories.map(s=>`
          <div class="repository-card ${P.some(i=>i.url===s.clone_url)?"selected":""}" data-repo-url="${s.clone_url}" onclick="toggleRepositorySelection('${s.clone_url}', '${s.name}')">
            <h3>${s.name}</h3>
            <p style="color: var(--text-secondary); margin: 0.5rem 0;">
        ...
        `).join(""),he()}else t.innerHTML=`<div class="empty-state"><p>${o.detail||"Error loading repositories"}</p></div>`}catch{t.innerHTML='<div class="empty-state"><p>Error loading repositories</p></div>'}}function zt(e,t){const n=P.findIndex(o=>o.url===e);if(n>=0)P.splice(n,1),he();else{if(P.length>=2){p("You can only select up to 2 repositories for a split repository","error");return}P.push({url:e,name:t}),P.length===2&&qt(),he()}}function qt(){const[e,t]=P,n=document.createElement("div");n.className="modal-overlay",n.id="splitImportModal";const o=document.createElement("div");o.className="modal-content enhanced",o.innerHTML=`
...
Click OK to import these repositories as a multi-repository project.`)&&Ye(e.url,t.url,`${e.name}-${t.name}`)}async function Ye(e,t,n){const o=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!o){p("Please login first","error");return}try{p("Importing multi-repositories...","info");const s=await fetch("/api/import-split",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:`Bearer ${o}`},body:new URLSearchParams({frontend_url:e,backend_url:t,app_name:n})}),a=await s.json();if(s.ok){p("Multi-repository imported successfully! Navigate to Projects to see it.","success"),P=[];const i=document.getElementById("page-projects");i&&i.style.display!=="none"&&O(),document.getElementById("usernameSearch").value.trim()&&Ge()}else s.status===423?p(a.detail||"Your virtual machine is being created. Please wait a few moments and try again.","warning"):p(a.detail||"Failed to import multi-repository","error")}catch(s){console.error("Error importing multi-repositories:",s),p("Failed to import multi-repository: "+s.message,"error")}}function Wt(e){document.getElementById("git-url").value=e,U.navigate("/deploy"),p("Repository selected","success")}async function Gt(e,t){const n=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!n){p("Please login first","error");return}try{p("Importing repository...","info");const o=await fetch("/api/import",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:`Bearer ${n}`},body:new URLSearchParams({git_url:e,app_name:t||e.split("/").pop()||"Untitled Project"})}),s=await o.json();if(o.ok){p("Repository imported successfully! Navigate to Projects to see it.","success");const a=document.getElementById("page-projects");a&&a.style.display!=="none"&&O()}else o.status===423?p(s.detail||"Your virtual machine is being created. Please wait a few moments and try again.","warning"):p(s.detail||"Failed to import repository","error")}catch(o){console.error("Error importing repository:",o),p("Failed to import repository: "+o.message,"error")}}function Yt(){const e=document.getElementById("repositoriesGrid"),t=document.getElementById("usernameSearch");if(!e)return;let n=!1;try{const o=localStorage.getItem("repos.lastUsername")||"",s=localStorage.getItem("repos.lastData");if(s){const a=JSON.parse(s);Array.isArray(a)&&a.length>=0&&(t&&(t.value=o),e.innerHTML=a.map(i=>`
          ...
          `).join(""),he(),n=!0)}}catch{}n||(e.innerHTML=`
      <div class="empty-state">
    ...
    `)}function p(e,t="info"){const n=document.getElementById("toast");n.textContent=e,n.className=`toast show ${t}`,setTimeout(()=>{n.classList.remove("show")},3e3)}let te={},je=[];async function De(){try{const e=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!e){const n=document.getElementById("envVarsList");n&&(n.innerHTML=`
        ...
        `),ke();return}if(!r||!r.id){const n=document.getElementById("envVarsList");n&&(n.innerHTML=`
          <div class="empty-state">
            <p>Please select a project from the Projects page to manage environment variables</p>
          </div>
        `),ke();return}const t=await fetch(`/api/env-vars?project_id=${r.id}`,{headers:{Authorization:`Bearer ${e}`}});if(t.ok){const n=await t.json();te=n.variables||{},je=n.vars_list||[],Kt()}else if(t.status===401){localStorage.removeItem("access_token"),localStorage.removeItem("authToken"),be();const n=document.getElementById("envVarsList");n&&(n.innerHTML=`
          <div class="empty-state">
            <p>Please log in to manage environment variables</p>
            <a href="/login" class="btn-primary">Login</a>
          </div>
        `)}else console.error("Failed to load environment variables")}catch(e){console.error("Error loading environment variables:",e)}ke()}function ke(){const e=document.getElementById("importEnvBtn"),t=document.getElementById("addEnvVarBtn"),n=document.getElementById("importEnvCard"),o=document.getElementById("cancelImportBtn"),s=document.getElementById("importEnvForm"),a=document.getElementById("envDropZone"),i=document.getElementById("envFileInput"),l=document.getElementById("envDropZoneBrowse"),d=document.getElementById("envDropZoneFileName");if(e&&(e.onclick=()=>{n.style.display=n.style.display==="none"?"block":"none"}),o&&(o.onclick=()=>{n.style.display="none",i&&(i.value=""),d&&(d.textContent="",d.style.display="none")}),t&&(t.onclick=()=>{Zt()}),i&&(i.onchange=c=>{var u;const m=(u=c.target.files)==null?void 0:u[0];d&&(m?(d.textContent=m.name,d.style.display="block"):(d.textContent="",d.style.display="none"))}),a&&i&&!a.dataset.bound){a.dataset.bound="true";const c=m=>{m.preventDefault(),m.stopPropagation()};["dragenter","dragover"].forEach(m=>{a.addEventListener(m,u=>{c(u),a.classList.add("is-dragover")})}),["dragleave","dragend"].forEach(m=>{a.addEventListener(m,u=>{c(u),a.classList.remove("is-dragover")})}),a.addEventListener("dragover",m=>{c(m),m.dataTransfer&&(m.dataTransfer.dropEffect="copy"),a.classList.add("is-dragover")}),a.addEventListener("drop",async m=>{var f;c(m),a.classList.remove("is-dragover");const u=(f=m.dataTransfer)==null?void 0:f.files;if(!u||!u.length)return;const[y]=u;if(d&&(d.textContent=y.name,d.style.display="block"),i)try{const g=new DataTransfer;g.items.add(y),i.files=g.files}catch(g){console.warn("Unable to sync dropped file with input element:",g)}try{await Ve(y)}catch(g){console.error("Error importing dropped .env file:",g)}}),a.addEventListener("click",()=>{i.click()}),l&&l.addEventListener("click",m=>{m.preventDefault(),i.click()})}s&&(s.onsubmit=async c=>{var u;c.preventDefault();const m=(u=i==null?void 0:i.files)==null?void 0:u[0];m&&await Ve(m)})}async function Ve(e){try{if(!e){p("No file detected for import","error");return}p(`Importing ${e.name||".env"}...`,"info");const n=(await e.text()).split(`
`),o={};n.forEach(a=>{if(a=a.trim(),a&&!a.startsWith("#")&&a.includes("=")){const[i,...l]=a.split("="),d=l.join("=").trim().replace(/^["']|["']$/g,"");i.trim()&&(o[i.trim()]=d)}}),te={...te,...o},await Ne(),document.getElementById("importEnvCard").style.display="none",document.getElementById("envFileInput").value="";const s=document.getElementById("envDropZoneFileName");s&&(s.textContent="",s.style.display="none"),p("Environment variables imported successfully!","success")}catch(t){console.error("Error importing .env file:",t),p("Failed to import .env file","error")}}function Kt(){const e=document.getElementById("envVarsList");if(e){if(je.length===0){e.innerHTML=`
      <div class="empty-state">
  ...
  `}}function Zt(){Te()}function Te(e=null,t=""){const n=document.getElementById("envVarModal"),o=document.getElementById("modalVarKey"),s=document.getElementById("modalVarValue"),a=document.getElementById("modalTitle");e?(a.textContent="Update environment variable",o.value=e,o.readOnly=!0,s.value=t):(a.textContent="Add environment variable",o.value="",o.readOnly=!1,s.value=""),n.style.display="flex"}function Ke(){const e=document.getElementById("envVarModal");e.style.display="none"}async function Jt(){const e=document.getElementById("modalVarKey"),t=document.getElementById("modalVarValue"),n=e.value.trim(),o=t.value.trim();if(!n){p("Variable name is required","error");return}te[n]=o,await Ne(),Ke()}function Ze(e){const t=te[e]||"";Te(e,t)}async function Qt(e){Ze(e)}async function Xt(e){confirm(`Are you sure you want to delete ${e}?`)&&(delete te[e],await Ne(),p("Environment variable deleted","success"))}function en(e){const n=document.querySelectorAll(".env-var-row")[e];if(!n)return;const o=n.querySelector(".env-var-value input");o.type==="password"?o.type="text":o.type="password"}async function Ne(){try{const e=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!r||!r.id){p("No project selected","error");return}(await fetch("/api/env-vars",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({variables:te,project_id:r.id})})).ok?(await De(),p("Environment variables saved successfully","success")):(console.error("Failed to save environment variables"),p("Failed to save environment variables","error"))}catch(e){console.error("Error saving environment variables:",e),p("Error saving environment variables","error")}}function tn(){const e=document.getElementById("modalVarValue"),t=document.querySelector('#envVarModal button[onclick*="toggleModalValueVisibility"]');e&&t&&(e.type==="password"?(e.type="text",t.textContent="🙈 Hide"):(e.type="password",t.textContent="👁️ Show"))}function b(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}async function Je(){try{const e=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!e)return;const t=await fetch("/api/user/profile",{headers:{Authorization:`Bearer ${e}`}});if(t.ok){const n=await t.json(),o=document.getElementById("userName"),s=document.getElementById("userEmail"),a=document.getElementById("userAvatar");localStorage.setItem("displayName",n.display_name||""),localStorage.setItem("userEmail",n.email||""),o&&(o.textContent=n.display_name||n.username||"User"),dn(n.display_name||n.username||"User");const i=document.getElementById("sidebarSearch");if(i){const l=i.value.trim();(l===(n.username||"")||l===(n.display_name||""))&&(i.value="")}s&&(s.textContent=n.email||"Logged in"),a&&(n.avatar_url?(a.style.backgroundImage=`url(${n.avatar_url})`,a.style.backgroundSize="cover",a.style.backgroundPosition="center",a.textContent=""):(a.style.backgroundImage="",a.textContent=(n.display_name||n.username||"U").charAt(0).toUpperCase()))}else t.status===401&&(localStorage.removeItem("access_token"),localStorage.removeItem("authToken"),localStorage.removeItem("username"),be())}catch(e){console.error("Error loading user profile:",e)}}async function Qe(){try{const e=localStorage.getItem("access_token")||localStorage.getItem("authToken"),t=await fetch("/api/user/profile",{headers:{Authorization:`Bearer ${e}`}});if(t.ok){const n=await t.json(),o=document.getElementById("username"),s=document.getElementById("email"),a=document.getElementById("displayName");o&&(o.value=n.username||""),s&&(s.value=n.email||""),a&&(a.value=n.display_name||"");const i=document.getElementById("avatarPreview"),l=document.getElementById("avatarInitial"),d=document.getElementById("removeAvatarBtn");if(n.avatar_url&&i)i.src=n.avatar_url,i.style.display="block",l&&(l.style.display="none"),d&&(d.style.display="block");else if(l){const c=n.display_name&&n.display_name.charAt(0).toUpperCase()||n.username&&n.username.charAt(0).toUpperCase()||"S";l.textContent=c,l.style.display="block"}}}catch(e){console.error("Error loading profile:",e)}nn()}function nn(){const e=document.getElementById("profileForm"),t=document.getElementById("avatarFile"),n=document.getElementById("removeAvatarBtn");e&&e.addEventListener("submit",cn),t&&t.addEventListener("change",rn),n&&n.addEventListener("click",ln);const o=document.getElementById("changePasswordBtn"),s=document.getElementById("closePasswordModal"),a=document.getElementById("cancelPasswordBtn"),i=document.getElementById("updatePasswordBtn"),l=document.getElementById("passwordModal"),d=document.getElementById("modalNewPassword"),c=document.getElementById("strengthFill");o&&o.addEventListener("click",()=>{l&&(l.style.display="flex")}),s&&s.addEventListener("click",()=>{l&&(l.style.display="none")}),a&&a.addEventListener("click",()=>{l&&(l.style.display="none")}),l&&l.addEventListener("click",y=>{y.target===l&&(l.style.display="none")}),d&&d.addEventListener("input",y=>{const f=y.target.value;let g=0;f.length>=8&&(g+=25),/[a-z]/.test(f)&&/[A-Z]/.test(f)&&(g+=25),/\d/.test(f)&&(g+=25),/[!@#$%^&*(),.?":{}|<>]/.test(f)&&(g+=25),c&&(c.style.width=`${g}%`,g<50?c.style.background="#ef4444":g<75?c.style.background="#f59e0b":c.style.background="#10b981")}),i&&i.addEventListener("click",an);const m=document.getElementById("cancelProfileBtn");m&&m.addEventListener("click",async()=>{await Qe()});const u=document.getElementById("deleteAccountBtn");u&&u.addEventListener("click",async()=>{await on()})}async function on(){if(await sn())try{const t=localStorage.getItem("access_token")||localStorage.getItem("authToken");if(!t){p("You must be logged in to delete your account","error");return}const n=document.getElementById("deleteAccountBtn");n&&(n.disabled=!0,n.textContent="Deleting Account...");const o=await fetch("/api/user/account",{method:"DELETE",headers:{Authorization:`Bearer ${t}`}}),s=await o.json();o.ok?(p("Account deleted successfully","success"),localStorage.clear(),setTimeout(()=>{window.location.href="/login"},2e3)):(p(s.detail||s.message||"Failed to delete account","error"),n&&(n.disabled=!1,n.textContent="Delete Account"))}catch(t){console.error("Error deleting account:",t),p("Network error. Please try again.","error");const n=document.getElementById("deleteAccountBtn");n&&(n.disabled=!1,n.textContent="Delete Account")}}function sn(){return new Promise(e=>{const t=document.createElement("div");t.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      right: 0;
    ...
    `,t.appendChild(n),document.body.appendChild(t),n.querySelector("#cancelDeleteBtn").addEventListener("click",()=>{document.body.removeChild(t),e(!1)}),n.querySelector("#confirmDeleteBtn").addEventListener("click",()=>{document.body.removeChild(t),e(!0)}),t.addEventListener("click",i=>{i.target===t&&(document.body.removeChild(t),e(!1))});const a=i=>{i.key==="Escape"&&(document.body.removeChild(t),document.removeEventListener("keydown",a),e(!1))};document.addEventListener("keydown",a)})}async function an(){const e=document.getElementById("modalCurrentPassword"),t=document.getElementById("modalNewPassword"),n=document.getElementById("modalConfirmPassword"),o=document.getElementById("passwordModal");if(!e||!t||!n)return;const s=e.value,a=t.value,i=n.value;if(!s||!a||!i){p("Please fill in all password fields","error");return}if(a!==i){p("New passwords do not match","error");return}if(a.length<8){p("Password must be at least 8 characters","error");return}try{const l=localStorage.getItem("access_token")||localStorage.getItem("authToken"),d=new FormData;d.append("current_password",s),d.append("new_password",a);const c=await fetch("/api/user/profile",{method:"PUT",headers:{Authorization:`Bearer ${l}`},body:d}),m=await c.json();if(c.ok){p("Password updated successfully!","success"),o&&(o.style.display="none"),e.value="",t.value="",n.value="";const u=document.getElementById("strengthFill");u&&(u.style.width="0%")}else p(m.detail||m.message||"Failed to update password","error")}catch(l){console.error("Error updating password:",l),p("Network error. Please try again.","error")}}function rn(e){const t=e.target.files[0];if(t){const n=new FileReader;n.onload=o=>{const s=document.getElementById("avatarPreview"),a=document.getElementById("avatarInitial");s&&(s.src=o.target.result,s.style.display="block"),a&&(a.style.display="none");const i=document.getElementById("removeAvatarBtn");i&&(i.style.display="block")},n.readAsDataURL(t)}}function ln(){const e=document.getElementById("avatarPreview"),t=document.getElementById("avatarInitial");e&&(e.src="",e.style.display="none"),t&&(t.style.display="block");const n=document.getElementById("removeAvatarBtn");n&&(n.style.display="none");const o=document.getElementById("avatarFile");o&&(o.value="")}async function cn(e){e.preventDefault();const t=document.getElementById("profileMessage");t&&(t.style.display="none");const n=new FormData,o=document.getElementById("email"),s=document.getElementById("displayName");o&&n.append("email",o.value),s&&n.append("display_name",s.value);const a=document.getElementById("avatarFile");a&&a.files[0]&&n.append("avatar",a.files[0]);const i=document.getElementById("avatarPreview");i&&i.style.display==="none"&&n.append("remove_avatar","true");try{const l=localStorage.getItem("access_token")||localStorage.getItem("authToken"),d=await fetch("/api/user/profile",{method:"PUT",headers:{Authorization:`Bearer ${l}`},body:n}),c=await d.json();if(d.ok)t&&(t.textContent="Profile updated successfully!",t.className="profile-message success",t.style.display="block"),c.username&&localStorage.setItem("username",c.username),await Je(),p("Profile updated successfully!","success");else{const m=c.detail||c.message||"Failed to update profile";t&&(t.textContent=m,t.className="profile-message error",t.style.display="block"),p(m,"error"),console.error("Profile update failed:",c)}}catch(l){console.error("Error updating profile:",l),t&&(t.textContent="Network error. Please try again.",t.className="profile-message error",t.style.display="block"),p("Network error. Please try again.","error")}}window.destroyDeployment=Vt;window.selectRepository=Wt;window.importRepository=Gt;window.editEnvVar=Qt;window.deleteEnvVar=Xt;window.toggleEnvVarVisibility=en;window.saveEnvVarFromModal=Jt;window.closeEnvVarModal=Ke;window.toggleModalValueVisibility=tn;window.editEnvVarModal=Ze;window.showEnvVarModal=Te;window.selectProject=Ce;window.showProjectSidebar=xe;window.hideProjectSidebar=ht;window.openProject=Ut;window.loadUserProfileIntoProjectSidebar=We;window.openProjectSite=gt;window.deleteProject=tt;window.toggleRepositorySelection=zt;window.confirmSplitImport=Ot;window.openProjectNameModal=qe;window.openSite=Ct;function dn(e){const t=document.getElementById("teamName");t&&(t.textContent=`${e}'s team`),document.querySelectorAll(".project-owner").forEach(o=>{o.textContent=`${e}'s team`})}function mn(e){if(e==null)return null;if(typeof e!="string")return e;const t=e.trim();if(!t)return null;const n=t.indexOf("{");if(n===-1)return{message:t};const o=t.slice(n);try{return JSON.parse(o)}catch{return{message:t}}}let H=null,se=!1,Z=[];function Xe(e){H&&H.close();const n=`${window.location.protocol==="https:"?"wss:":"ws:"}//${window.location.host}/ws/project/${e}/logs`;H=new WebSocket(n),H.onopen=()=>{console.log(`Project logs WebSocket connected for project ${e}`);const o=document.getElementById("projectLogsContent");o&&o.querySelector("p")&&(o.innerHTML=""),Z.length>0&&(Z.forEach(s=>q(s.message,s.type)),Z=[]),pn()},H.onmessage=o=>{const s=mn(o.data);!s||!s.message||s.type==="ping"||!s.message.trim()||(se?Z.push({message:s.message,type:s.type||"info"}):q(s.message,s.type||"info"))},H.onerror=o=>{console.error("Project logs WebSocket error:",o),q("WebSocket connection error","error")},H.onclose=()=>{console.log("Project logs WebSocket disconnected"),setTimeout(()=>{const o=document.getElementById("page-project-logs");o&&o.style.display!=="none"&&r&&Xe(r.id)},3e3)}}function q(e,t="info"){const n=document.getElementById("projectLogsContent");if(!n)return;const o=new Date().toLocaleString("en-US",{timeZone:"Asia/Kathmandu",timeStyle:"medium",dateStyle:"short"}),s=document.createElement("div");s.className=`log-entry ${t}`,s.innerHTML=`
    <span class="log-timestamp">[${o}]</span>
    <span class="log-message">${b(e)}</span>
  `,n.appendChild(s),n.scrollTop=n.scrollHeight;const a=1e3,i=n.querySelectorAll(".log-entry");i.length>a&&i[0].remove()}function pn(){const e=document.getElementById("clearProjectLogsBtn"),t=document.getElementById("toggleProjectLogsBtn");if(e&&(e.replaceWith(e.cloneNode(!0)),document.getElementById("clearProjectLogsBtn").addEventListener("click",()=>{const o=document.getElementById("projectLogsContent");o&&(o.innerHTML="",Z=[],q("Logs cleared","info"))})),t){t.replaceWith(t.cloneNode(!0));const n=document.getElementById("toggleProjectLogsBtn");n.addEventListener("click",()=>{se=!se,n.textContent=se?"Resume":"Pause",!se&&Z.length>0&&(Z.forEach(o=>q(o.message,o.type)),Z=[]),q(se?"Logs paused":"Logs resumed","info")})}}window.addEventListener("beforeunload",()=>{logsWebSocket&&logsWebSocket.close(),H&&H.close(),A&&A.close()});let A=null,ye=!1,Be=[];function un(){document.querySelectorAll(".page").forEach(t=>{t.style.display="none"});const e=document.getElementById("page-deployment-logs");if(e){e.style.display="block",document.getElementById("pageTitle").textContent="Deployment Logs";const t=document.getElementById("deploymentLogsContent");t&&(t.innerHTML='<p style="text-align: center; color: var(--text-secondary); padding: 2rem;">Connecting to deployment stream... Logs will appear here.</p>');const n=document.getElementById("deployment-status-badge"),o=document.getElementById("deployment-status-text");n&&(n.className="status-badge status-info"),o&&(o.textContent="Deploying...")}}function yn(){A&&A.close();const e=window.location.protocol==="https:"?"wss:":"ws:",t=`deploy-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,n=`${e}//${window.location.host}/ws/${t}`;A=new WebSocket(n),A.onopen=()=>{console.log("Deployment logs WebSocket connected"),V("Connected to deployment stream","success")},A.onmessage=o=>{try{const s=JSON.parse(o.data);s.message&&(V(s.message,s.type||"info"),s.message.includes("Deployment successful")||s.message.includes("🎉")?ae("success","Deployment Successful"):s.message.includes("failed")||s.message.includes("❌")?ae("error","Deployment Failed"):(s.message.includes("Deploying")||s.message.includes("🚀"))&&ae("info","Deploying..."))}catch{V(o.data,"info")}},A.onerror=o=>{console.error("Deployment logs WebSocket error:",o),V("WebSocket connection error","error")},A.onclose=()=>{console.log("Deployment logs WebSocket disconnected"),V("Disconnected from deployment stream","warning")}}function V(e,t="info"){const n=document.getElementById("deploymentLogsContent");if(!n)return;n.querySelector('p[style*="text-align: center"]')&&(n.innerHTML="");const o=document.createElement("div");o.className=`log-entry log-${t}`,o.style.cssText="padding: 0.5rem; border-bottom: 1px solid var(--border-light); font-family: monospace; font-size: 0.875rem;";const s=new Date().toLocaleTimeString();o.innerHTML=`<span style="color: var(--text-secondary); margin-right: 0.5rem;">[${s}]</span><span>${b(e)}</span>`,n.appendChild(o),n.scrollTop=n.scrollHeight}function ae(e,t){const n=document.getElementById("deployment-status-badge"),o=document.getElementById("deployment-status-text");n&&(n.className=`status-badge status-${e}`),o&&(o.textContent=t)}async function gn(e){if(!e)return!1;try{const t=await fetch(e,{method:"HEAD",mode:"no-cors",cache:"no-cache"});return!0}catch{return new Promise(n=>{const o=new Image,s=setTimeout(()=>{n(!1)},5e3);o.onload=()=>{clearTimeout(s),n(!0)},o.onerror=()=>{clearTimeout(s),n(e.startsWith("http://")||e.startsWith("https://"))};const a=e.endsWith("/")?e+"favicon.ico":e+"/favicon.ico";o.src=a})}}function fn(e){A&&(A.close(),A=null),document.querySelectorAll(".page").forEach(s=>{s.style.display="none"});const t=document.getElementById("page-deployment-success");if(t){t.style.display="block",document.getElementById("pageTitle").textContent="Deployment Successful";const s=(r==null?void 0:r.name)||e.project_name||"Untitled Project",a=e.deployed_url||"";document.getElementById("success-project-name").textContent=s,document.getElementById("success-deployed-url").textContent=a||"Not available";const i=document.getElementById("success-status");if(a?(i.textContent="Checking...",i.style.color="var(--text-secondary)",gn(a).then(l=>{if(l)i.textContent="Running",i.style.color="var(--success)";else{i.textContent="Service Unavailable",i.style.color="var(--error)";const d=document.getElementById("deployment-info");if(d&&!d.querySelector(".service-warning")){const c=document.createElement("div");c.className="service-warning",c.style.cssText="margin-top: 1rem; padding: 1rem; background: var(--warning-bg, #fff3cd); border-left: 4px solid var(--warning, #ffc107); border-radius: 4px; color: var(--text-primary);",c.innerHTML=`
